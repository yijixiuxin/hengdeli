$j(function(){
	$j.fn.extend({
		SimpleTree:function(options){
			...
			/* 设置所有超链接不响应单击事件 */
			this.find("a").click(function(){ $j(this).parents("li").click(); return false; });
			...
			this.find("li").click(function(){
				 ...
				 * 否则修改其 show 属性为 true
				 */
				if($j(this).next("ul").attr("show")=="true"){
					$j(this).next("ul").attr("show","false");					
				}else{
					$j(this).next("ul").attr("show","true");
				}
